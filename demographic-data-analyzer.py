...
def calculate_demographic_data(print_data=True):
    ...
    higher_education = df.loc[(df["education"] == "Masters") | (df["education"] == "Doctorate") | (df["education"] == "Bachelors"), "salary"].count()
    lower_education = df.shape[0] - df.loc[(df["education"] == "Masters") | (df["education"] == "Doctorate") | (df["education"] == "Bachelors"), "salary"].count()

    # percentage with salary >50K
    higher_education_rich = round(df.loc[((df["education"] == "Masters") | (df["education"] == "Doctorate") | (df["education"] == "Bachelors")) & (df["salary"] == ">50K"), "salary"].count() / higher_education * 100, 1)
    lower_education_rich = round(df.loc[(df["education"] != "Masters") & (df["education"] != "Doctorate") & (df["education"] != "Bachelors") & (df["salary"] == ">50K"), "salary"].count() / lower_education * 100, 1)
